...
(* OASIS_START *)
(* DO NOT EDIT (digest: be090f89528f3a188a2638029f87ac09) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage =
            Some "https://github.com/mwweissmann/ocaml-posix-realtime/";
          bugreports = None;
          synopsis = "POSIX time values";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources = [];
                      bs_data_files =
                        [("posix-time.h", Some "$libdir/$pkg_name")];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for POSIX time";
                      doc_authors = [];
                      doc_abstract = None;
     ...
     oasis_version = "0.4.8";
     oasis_digest =
       Some "\223\187\025\240r\155\168P\159\145\183+\213\137\136\202";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
